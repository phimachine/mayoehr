...
class TransformerMixedAttn(nn.Module):
    ...
    def rvat(self, output, aoutput):
        ...
        # for binary, I changed this to mean from sum(dim=1)
        dkl = dkl.mean(dim=1).mean(dim=0)
...
if __name__ == '__main__':
    ...
    model=TransformerMixedAttn(binary_criterion=binary_criterion,real_criterion=real_criterion,

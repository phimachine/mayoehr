...
class ADNCMEM(nn.Module):
    ...
    def forward_one_step(self, step_input):
        ...
        read_weightings = self.read_weightings(read_keys, read_strengths,
                                               read_modes)
    ...
    def read_weightings(self, read_keys,

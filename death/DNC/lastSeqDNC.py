...
class LastSeqDNC(nn.Module):
    def __init__(self,
                 ...
                 R,
                 N):
        super(LastSeqDNC, self).__init__()
...
if __name__ == '__main__':
    ...
    # make some fake dataset
    input=Variable(torch.randn(145,7298))
    target=Variable(torch.randn(3592))
    pred=dnc(input)

# THIS FILE DOES NOT HAVE CONVERGENCE PROBLEM!
# THIS FILE HAS MEMORY LEAK!
# USE THIS FILE TO IDENTIFY THE IMPLEMENTATION PROBLEM!
from death.DNC.original import Frankenstein as DNC
import torch
import numpy
